...
import { ShoppingCart, ArrowRight, Smartphone, Zap, ShieldCheck } from 'lucide-react'

// --- LA MÉTHODE METADATA A ÉTÉ SUPPRIMÉE D'ICI ---
...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    document.title = "Alluvi Health-Care | Secured Pharmaceutical Logistics UK";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) {
      metaDesc.setAttribute("content", "Licensed, temperature-controlled, and discreet pharmaceutical logistics across the UK. Secure healthcare distribution.");
    }
    ...
    <div className="min-h-screen bg-white text-[#0A0A0B]">
      ...
      <section className="relative bg-[#050505] min-h-[85vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 flex items-center justify-between">
          ...
          >
            <img src="/hero-right-arch.png" className="w-full h-full object-contain p-1 scale-110 z-10 relative" alt="Research Compound" />
          </motion.div>

          {/* BLOC CENTRAL */}
          <div className="flex flex-col items-center text-center flex-grow px-10">
            <img src="/leaf-icon-gray.png" className="w-14 h-14 mb-8 opacity-70" alt="Logo Icon" />
            ...
            <p className="text-xl md:text-3xl text-gray-400 font-medium tracking-tight mb-12">
              The Gold Standard of <span className="text-[#EF6C00] font-bold">Research</span> Logistics!
            </p>
          ...
          >
            <img src="/hero-left-arch.png" className="w-full h-full object-contain p-1 scale-110 z-10 relative" alt="Medical Precision" />
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="bg-[#EF6C00] rounded-xl p-10 flex flex-col justify-end min-h-[450px] relative overflow-hidden group">
               ...
               <div className="relative z-10">
                 <img src="/leaf-white.png" className="w-8 mb-6" alt="Icon" />
                 <h3 className="text-3xl font-black text-white leading-tight">Alluvi<br/>Healthcare<br/>Retatrutide</h3>
               </div>
            </div>
            {products.map((product) => (
              <div key={product.id} className="group border border-gray-100 rounded-xl p-6 flex flex-col hover:shadow-xl transition-all">
                ...
                <button onClick={() => addToCart(product)} className="w-full border border-gray-200 py-3 rounded-md text-[10px] font-black uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-black hover:text-white transition-colors">
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2">
              <div className="w-12 h-12 bg-[#22C55E] rounded-lg flex items-center justify-center mb-8 shadow-lg shadow-green-200">
                <img src="/leaf-white.png" className="w-6 h-6" alt="Certification" />
              </div>
              ...
              <p className="text-gray-500 leading-relaxed mb-6 max-w-lg">
                Part of <span className="text-[#EF6C00] font-bold">Alluvi Labs'</span> ongoing research program. This formulation is supplied in controlled batches for laboratory analysis.
              </p>
              <p className="text-[11px] font-black uppercase tracking-widest text-gray-400 mb-10">Laboratory Research Only.</p>
            ...
            <div className="lg:w-1/2 relative">
              <img src="/supplement-box.png" alt="Supplement Box" className="relative z-10 w-full drop-shadow-[0_35px_35px_rgba(0,0,0,0.15)] scale-110 lg:translate-x-10" />
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-[#EF6C00]/5 -z-0 rounded-full animate-pulse" />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-black">
            <div className="flex items-center gap-6">
              ...
              <div>
                ...
                <p className="text-[11px] font-bold text-black/50 uppercase">Reliable UK Wide Logistics</p>
              </div>
            </div>
            <div className="flex items-center gap-6">
              <div className="w-16 h-16 border-2 border-black/10 rounded-2xl flex items-center justify-center shrink-0">
        ...
        {addedProduct && (
          <>
            ...
            <motion.div initial={{ scale: 0.9, opacity: 0, y: 20 }} animate={{ scale: 1, opacity: 1, y: 0 }} exit={{ scale: 0.9, opacity: 0, y: 20 }} className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90%] max-w-md bg-white z-[310] rounded-xl p-8 shadow-2xl text-center">
              ...
              <img src={addedProduct.main_image_url} className="w-20 h-20 mx-auto object-contain mb-4" alt="Added product" />
              <h6 className="font-bold text-sm mb-6 text-black">{addedProduct.name}</h6>
      ...
      <section className="relative bg-[#050505] py-32 overflow-hidden border-t border-white/5">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
            <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} className="text-[#EF6C00] font-bold text-lg mb-8 tracking-tight">
              A New Era of Pharmaceutical Research
            </motion.p>
            <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} className="flex items-center justify-center gap-4 mb-10">
              <h2 className="text-white text-5xl md:text-7xl font-black uppercase tracking-[-0.04em] flex items-center gap-3">
                ALLUVI <img src="/leaf-white.png" className="w-12 h-12 md:w-16 md:h-16" alt="Icon" /> LABS
              </h2>
            </motion.div>
            <motion.h3 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} className="text-white text-3xl md:text-5xl font-semibold mb-12 tracking-tight leading-tight max-w-3xl mx-auto">
              Engineered For Research Precision.
            </motion.h3>
            <Link href="/products" className="group relative inline-flex items-center justify-center px-10 py-4 border border-white/60 rounded-lg overflow-hidden text-white font-bold uppercase text-[12px] tracking-[0.15em] transition-all">
              <span className="absolute inset-0 bg-[#EF6C00] translate-y-full group-hover:translate-y-0 transition-transform duration-300" />
              <span className="relative z-10 flex items-center gap-3">Shop Alluvi Items <ArrowRight size={16} /></span>
            </Link>
        </div>
      </section>
